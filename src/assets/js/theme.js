$(function() {
  ...
  function n() {
    ...
    a = e.hasClass("masonry") ? "masonry" : "fitRows", e.isotope({
  ...
  function c() {
    ...
    }), $(".tab-content > .tab-pane").hide(), $(".tab-content > .tab-pane:first-of-type").show(), $(".tabs a").click(function(a) {
      a.preventDefault();
      var e = $(this),
